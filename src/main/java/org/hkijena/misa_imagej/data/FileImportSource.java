...
import org.hkijena.misa_imagej.IOHelper;
...
public class FileImportSource implements MISADataImportSource {

    private MISAImportedData importedData;
    private Path path;

    public FileImportSource(MISAImportedData importedData, Path path) {
