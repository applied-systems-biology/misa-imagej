...
public class MISARunDialog extends JDialog {
    ...
    private void initialize() {
        ...
        UIHelper.createDescriptionLabelUI(formPanel, "Parameter file", 1, 0);
        ...
        UIHelper.createDescriptionLabelUI(formPanel, "Executable", 2, 0);
        ...
        UIHelper.createDescriptionLabelUI(formPanel, "Input data", 3, 0);
        ...
        UIHelper.createDescriptionLabelUI(formPanel, "Output data", 4, 0);
        ...
        UIHelper.addFillerGridBagComponent(formPanel, 5);
