...
public class MISADialog extends JFrame {
    ...
    public MISADialog(MISACommand command) {
        ...
        initialize();
        loadSchema(ResourceUtils.getPluginResourceAsStream("parameter-schema.json"));
    }
    ...
    private void exportMISARun() {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (!IOUtils.directoryIsEmpty(exportRunPath)) {
    ...
    private void runMISA() {
        ...
        if (dialog.showDialog() == MISARunDialog.ACCEPT_OPTION) {
            try {
                ...
                if (!IOUtils.directoryIsEmpty(dialog.getImportedPath())) {
                ...
                if (!IOUtils.directoryIsEmpty(dialog.getExportedPath())) {
